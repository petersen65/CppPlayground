...
template <typename ITEM, typename STATUS> class ProducerConsumerMock : public IProducerConsumer<ITEM, STATUS> {
  public:
    ...
    MOCK_METHOD(bool, finished, (), (override));
    MOCK_METHOD(bool, cancelled, (), (override));
